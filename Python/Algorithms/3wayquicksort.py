def ascendingPartition(arr, low, high):
    """
...
def descendingPartition(arr, low, high):
    """
    Partition the array into three parts:
...
def three_way_quicksort(arr, low, high, reverse=0):
    ...
    # partition the array
    if (reverse):
        i, j = descendingPartition(arr, low, high)
    else:
        i, j = ascendingPartition(arr, low, high)
...
if (__name__ == "__main__"):
    ...
    three_way_quicksort(arr, 0, len(arr) - 1, reverse=True)
    print(arr)